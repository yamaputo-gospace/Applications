        ...
        <form class="edit_user" enctype="multipart/form-data" action="/users/update" accept-charset="UTF-8" method="post">
          ...
          <div class="form-group">
            ...
            @if ($user->profile_photo)
              <img style="width:400px; height:400px;" src="{{ asset('storage/user_images/' . $user->profile_photo) }}" alt="avatar" />
              <input type="file" name="user_profile_photo"  value="{{ old('user_profile_photo', $user->profile_photo) }}" accept="image/jpeg,image/gif,image/png" />
            @else
              <img  style="width:400px; height:400px;" src="{{ asset('storage/images/blank_profile.png') }}" alt="avatar" />
              <input type="file" name="user_profile_photo"  value="" accept="image/jpeg,image/gif,image/png" />
            @endif
          </div>
