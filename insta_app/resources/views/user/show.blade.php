  ...
  <div class="row">
    <div class="col-md-4 text-center">
      @if ($user->profile_photo)
        <p>
          <img style="width:100px; height:100px; border-radius:50%; " class="round-img" src="{{ asset('storage/user_images/' . $user->profile_photo) }}" alt="avatar" />
        </p>
      @else
        <img style="width:100px; height:100px; border-radius:50%; " class="round-img" src="{{ asset('storage/images/blank_profile.png') }}" alt="avatar" />
      @endif
    </div>
    <div class="col-md-8">
      <div class="row">
